var coderr = (function (exports) {
    ...
    var VanillaContext = /** @class */ (function () {
        function VanillaContext(source, error) {
            this.source = source;
            this.error = error;
            this.contextType = 'Vanilla';
            this.contextCollections = [];
        }
        return VanillaContext;
    }());
    var Configuration = /** @class */ (function () {
        function Configuration(serverUrl, appKey) {
            /**
    ...
    var Reporter = /** @class */ (function () {
        ...
        Reporter.prototype.reportByContext = function (context) {
            var allCollections = [];
            allCollections.push.apply(allCollections, context.contextCollections);
            this.configuration.providers.forEach(function (provider) {
                var collections = provider.collect(context);
                allCollections.push.apply(allCollections, collections);
            });
            var report = {
                ReportId: uniqueid(),
        ...
        Reporter.prototype.convertErrorToDto = function (error) {
            var dto = {
                FullName: error.name,
    ...
    var DomErrorContext = /** @class */ (function () {
        function DomErrorContext(source, error, document, window) {
            this.source = source;
            this.error = error;
            this.document = document;
            this.window = window;
            this.contextType = 'DOM';
            this.contextCollections = [];
        }
        return DomErrorContext;
    }());
    var DomContextFactory = /** @class */ (function () {
        function DomContextFactory() {
        }
        DomContextFactory.prototype.canHandle = function (source, error) {
            if (window) {
                return true;
            }
            return source instanceof DomErrorContext;
        };
        DomContextFactory.prototype.createContext = function (source, error) {
    ...
    function registerDomProviders(providers) {
     ...
     */
    var DocumentCollectionProvider = /** @class */ (function () {
        function DocumentCollectionProvider() {
        }
        DocumentCollectionProvider.prototype.collect = function (context) {
    ...
    var NavigatorCollectionProvider = /** @class */ (function () {
        function NavigatorCollectionProvider() {
        }
        NavigatorCollectionProvider.prototype.collect = function (context) {
            var navigator = context.window.navigator;
            if (!navigator) {
                return [];
            }
            var col = toCollection('navigator', {
            ...
            var parser = new uaParser_1(navigator.userAgent);
            var uaCollection = toCollection('userAgent', {
                browser: {
        ...
        return NavigatorCollectionProvider;
    }());
    var ScreenCollectionProvider = /** @class */ (function () {
        function ScreenCollectionProvider() {
        }
        ScreenCollectionProvider.prototype.collect = function (context) {
            var screen = context.window.screen;
            if (!screen) {
                return [];
            }
            var col = toCollection('screen', {
        ...
        return ScreenCollectionProvider;
    }());
    var WindowProvider = /** @class */ (function () {
        function WindowProvider() {
        }
        WindowProvider.prototype.collect = function (context) {
            var window = context.window;
            if (!window) {
                return [];
            }
            var col = toCollection('window', {
    ...
    var Coderr = /** @class */ (function () {
        function Coderr(config) {
            this.config = config;
            this.reporter = new Reporter(config);
        }
        Coderr.prototype.catchDomErrors = function () {
            catchDomErrors(this.config);
        };
        Coderr.prototype.report = function (error, contextData) {
